...
class DebateDraftValidator
{
    ...
    public const CONTEXT_MIN_WORDS = 150;
    public const CONTEXT_MAX_WORDS = 350;
    ...
    public function validate(array $draft, array $evidenceUrls): array
    {
        ...
        // Es una intervención en párrafos: sin viñetas.
        if (preg_match('/^\s*[•\-–]\s/mu', $draft['context'])) {
            $errors[] = 'context lleva viñetas: tiene que ser una intervención en párrafos';
        }
